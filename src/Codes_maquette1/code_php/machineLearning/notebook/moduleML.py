...
def ml_exec():
    ...
    with open("C:\\Users\\chedo\\Documents\\BUT2\\www\\code_php\\machineLearning\\data\\web.csv", "w", newline='', encoding='utf-8') as csvfile:
      writer = csv.writer(csvfile, delimiter=',')
      writer.writerows(phrases_web)

    # Récupération des phrases scrapées
    dataframe_web = pan.read_csv("C:\\Users\\chedo\\Documents\\BUT2\\www\\code_php\\machineLearning\\data\\web.csv")

    model = load("C:\\Users\\chedo\\Documents\\BUT2\\www\\code_php\\machineLearning\\notebook\\model.logiR")
